    ...
    <Layout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-8 md:mb-12">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-2 md:mb-4">Live Matches</h1>
        ...
        {/* Status Filter */}
        <div className="flex flex-wrap gap-1 sm:gap-2 mb-6 md:mb-8 justify-center">
          {['all', 'live', 'upcoming', 'completed'].map((status) => (
            <Button
              ...
              className={`text-xs sm:text-sm px-2 sm:px-3 py-1 sm:py-2 ${selectedStatus === status 
                  ...
                  <CardContent className="p-0">
                    ...
                    <div className="p-3 sm:p-4">
                      ...
                      {stream.youtube_live_url && (
                        ...
                        >
                          <Button className="w-full bg-red-500 hover:bg-red-600 text-white font-bold text-xs sm:text-sm py-2 sm:py-3">
                            <Youtube className="w-3 h-3 sm:w-4 sm:h-4 mr-1 sm:mr-2" />
                            <span className="hidden sm:inline">Watch Live Stream</span>
